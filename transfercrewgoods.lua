...
--      local squadmaxf=playerHangar:getSquadMaxFighters(squad) //removed for test
      for j=squadmax, 11 do -- hiding unused slots in squad
        local findex
        findex = squad*12+j+1
...
--      local squadmaxf=selfHangar:getSquadMaxFighters(squad)   //removed for test
      for j=squadmax, 11 do -- hiding unused slots in squad
        local findex
        findex = squad*12+j+1
